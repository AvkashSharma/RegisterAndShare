...
public class Tracker {
  ...
  /**
   * This method adds request sent by the client to the HashMap and start the
   * timer
   * 
   * @param requestd
   */
  ...
  /**
   * This method keeps track of response received by the client. Stops the timer
   * and removes the Object from the HashMap
   * 
   * @param response
   */
  ...
  public static void handleReceivedResponse(Object response) {
    ...
    // Handle Client registration Denied
      ...
      if (ClientData.requestMap.containsKey(Rid)) {
        // System.out.println("--------------------------FOUND A REQUEST ID GOING TO
        ...
        // System.out.println("SIZE OF HASH MAP BEFORE: " +
        // ClientData.requestMap.size());
        ClientData.requestMap.remove(Rid);
        // print the size of the map
        // System.out.println("SIZE OF HASH MAP AFTER: " +
        // ClientData.requestMap.size());
      }
    }
